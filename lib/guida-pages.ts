...
export const guidaPages: GuidaPage[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Quando un sito parla di modelli verificati, cerca informazioni sul processo generale e sui controlli della piattaforma. SessoChat.net non attribuisce etichette di verifica a singoli profili se il feed non fornisce quel dato."
        ]
      },
      {
    ...
    ctaCopy:
      "Apri l'accesso partner solo dopo aver controllato anteprime, profili, mobile e condizioni principali.",
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "SessoChat.net mantiene un approccio informativo: non promette sicurezza assoluta e non sostituisce le condizioni ufficiali delle piattaforme partner."
        ]
      }
    ],
  ...
  },
  {
    ...
    ctaCopy:
      "Apri la piattaforma partner e controlla cosa è visibile prima di creare un account.",
    ctaHref: "/go/livejasmin",
  ...
  },
  {
    ...
    ctaCopy:
      "Valuta anteprime e condizioni sulla piattaforma partner prima di usare crediti o chat private.",
    ctaHref: "/go/livejasmin",
  ...
  },
  {
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          "Per questo una pagina editoriale seria non deve inventare badge, stati o garanzie individuali se il feed o la piattaforma non li mostra chiaramente."
        ]
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "SessoChat.net mostra modelli dal feed reale quando disponibile, ma non aggiunge etichette non fornite dal dato."
        ]
      }
    ],
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "Perché sarebbe fuorviante. Se il feed non fornisce un dato, SessoChat.net preferisce non mostrarlo."
      }
    ],
    related: [
      "chat-webcam-sicura",
    ...
    ctaCopy:
      "Apri il percorso partner e osserva come la piattaforma presenta profili, regole e informazioni disponibili.",
    ctaHref: "/go/livejasmin",
    ctaLabel: "Guarda le opzioni live"
  },
  {
    ...
    ctaCopy:
      "Apri l'accesso partner e valuta anteprime, profili e condizioni senza saltare subito alle funzioni avanzate.",
    ctaHref: "/go/signup",
  ...
  },
  {
    ...
    ctaCopy:
      "Apri la piattaforma partner e verifica leggibilità, anteprime e condizioni direttamente dal tuo dispositivo.",
    ctaHref: "/go/livejasmin",
    ctaLabel: "Guarda le opzioni live"
  },
  {
