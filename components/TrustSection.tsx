    ...
    <section className="section" aria-labelledby="privacy-title">
      <div className="container split-section">
        <div className="rich-panel">
          <p className="section-kicker">Scelta consapevole</p>
          ...
          <ul className="check-list">
            <li>Verifica se le anteprime gratuite sono separate dalle funzioni a pagamento.</li>
            <li>Controlla come sono presentati modelli webcam live e profili verificati.</li>
            <li>Preferisci pagine rapide, leggibili da telefono e prive di promesse eccessive.</li>
          </ul>
        </div>
        <div className="rich-panel" id="privacy-title">
          ...
          <p>
            ...
            della piattaforma, usa credenziali robuste e controlla le impostazioni del browser.
          </p>
          <div className="metric-grid">
            <div className="metric-card">
              <h3>Accesso mobile</h3>
              <p>Meglio interfacce chiare, pulsanti leggibili e pagine senza passaggi confusi.</p>
            </div>
            <div className="metric-card">
              <h3>Pagamenti</h3>
              <p>I prezzi chat webcam devono essere comprensibili prima di usare funzioni private.</p>
            </div>
            <div className="metric-card">
              <h3>Link interni</h3>
            ...
            <div className="metric-card">
              <h3>Tono discreto</h3>
              <p>Nessuna recensione finta, nessun voto inventato, nessuna promessa non verificata.</p>
            </div>
          </div>
        </div>
      </div>
